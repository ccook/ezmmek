...
```{r}
std_data <- read.csv("data/tyson_std_04172020.csv")
...
```{r}
raw_fsu_data_ibc <- read.csv("data/tyson_sat_german_04172020.csv")
...
```{r, eval = FALSE}
sat_fit_ibc <- new_ezmmek_sat_fit("data/tyson_std_04172020.csv", 
...
```{r}
sat_fit_isc <- new_ezmmek_sat_fit("data/tyson_std_04172020.csv",
...
```{r}
act_calibrate_ibc <- new_ezmmek_act_calibrate("data/tyson_std_04172020.csv",
                                              "data/tyson_sat_german_04172020.csv",
                                              site_name,
                                              std_type,
                                              method = "ibc",
...
```{r}
act_calibrate_isc <- new_ezmmek_act_calibrate("data/tyson_std_04172020.csv",
                                              "data/tyson_sat_steen_04172020.csv",
                                              site_name,
                                              std_type,
                                              method = "isc",
...
```{r}
act_group_ibc <- new_ezmmek_act_group("data/tyson_sat_german_04172020.csv",
                                      site_name,
                                      std_type,
                                      method = "ibc",
                                      columns = NULL)
...
```{r}
act_group_isc <- new_ezmmek_act_group("data/tyson_sat_steen_04172020.csv",
                                      site_name,
                                      std_type,
                                      method = "isc",
                                      columns = NULL)
...
```{r}
std_group_ibc <- new_ezmmek_std_group("data/tyson_std_04172020.csv",
                                      site_name,
                                      std_type,
                                      method = "ibc",
                                      columns = NULL)
...
```{r}
std_group_isc <- new_ezmmek_std_group("data/tyson_std_04172020.csv",
                                      site_name,
                                      std_type,
                                      method = "isc",
                                      columns = NULL)
