...
plot(new_ezmmek_sat_fit_obj_g, site.name, sub.type)
plot(new_ezmmek_sat_fit_obj_s, site.name, sub.type)
```  

#### 5.1.2 *new_ezmmek_calibrate*, "german" and "steen"  
Plot activities and their associated error
```{r, fig.width = 6, fig.asp = 0.618, fig.align = "center", warning = FALSE}
plot(new_ezmmek_act_calibrate_obj_g, site.name, sub.type)
plot(new_ezmmek_act_calibrate_obj_s, site.name, sub.type)
```

#### 5.1.3 *new_ezmmek_act_group*, "german" and "steen"
Plot raw activity data
```{r, fig.width = 6, fig.asp = 0.618, fig.align = "center"}
plot(new_ezmmek_act_group_obj_g, site.name, sub.type)
plot(new_ezmmek_act_group_obj_s, site.name, sub.type, sub.conc)
```

#### 5.1.4 *new_ezmmek_std_group*, "german" and "steen"
Plot standard curve(s)
```{r, fig.width = 6, fig.asp = 0.618, fig.align = "center"}
plot(new_ezmmek_std_group_obj_g, site.name, std.type)
plot(new_ezmmek_std_group_obj_s, site.name, std.type)
```
