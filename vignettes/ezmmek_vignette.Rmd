...
```{r}
new_ezmmek_sat_fit_obj <- new_ezmmek_sat_fit("data/victor_ashe_std_03172020.csv", 
...
tibble::glimpse(new_ezmmek_sat_fit_obj)
```
...
```{r}
new_ezmmek_act_calibrate_obj <- new_ezmmek_act_calibrate("data/victor_ashe_std_03172020.csv",
                                                 "data/victor_ashe_sat_german_03172020.csv",
                                                 site.name,
                                                 std.type,
                                                 method = "german",
...
tibble::glimpse(new_ezmmek_act_calibrate_obj)
```
#### 4.2.2 *new_ezmmek_act_calibrate*, "steen" method
```{r}
new_ezmmek_act_calibrate_obj <- new_ezmmek_act_calibrate("data/victor_ashe_std_03172020.csv",
                                                 "data/victor_ashe_sat_steen_03172020.csv",
                                                 site.name,
...
```{r}
new_ezmmek_act_group_obj <- new_ezmmek_act_group("data/victor_ashe_sat_german_03172020.csv",
                                                 site.name,
                                                 std.type,
                                                 method = "german",
                                                 columns = NULL)

tibble::glimpse(new_ezmmek_act_group_obj)
```
#### 4.3.2 *new_ezmmek_act_group*, "steen"
```{r}
new_ezmmek_act_group_obj <- new_ezmmek_act_group("data/victor_ashe_sat_steen_03172020.csv",
                                                 site.name,
                                                 std.type,
                                                 method = "steen",
                                                 columns = NULL)
...
```{r}
new_ezmmek_std_group_obj <- new_ezmmek_std_group("data/victor_ashe_std_03172020.csv",
                                                 site.name,
                                                 std.type,
                                                 method = "german",
                                                 columns = NULL)

tibble::glimpse(new_ezmmek_std_group_obj)
```
